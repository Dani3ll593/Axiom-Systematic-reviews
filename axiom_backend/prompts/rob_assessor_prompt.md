...
- *For NON-RANDOMIZED studies:* judgment = "n/a", and rationale states "Study is observational/non-randomized; randomization domain not applicable."
...
<json>
{
  "domain_1_randomization": { "judgment": "low|some|high|n/a", "rationale": "<1-2 sentences>" },
  "domain_2_deviations":    { "judgment": "low|some|high",     "rationale": "<1-2 sentences>" },
  "domain_3_missing_data":  { "judgment": "low|some|high",     "rationale": "<1-2 sentences>" },
  "domain_4_outcome_meas":  { "judgment": "low|some|high",     "rationale": "<1-2 sentences>" },
  "domain_5_reporting":     { "judgment": "low|some|high",     "rationale": "<1-2 sentences>" },
  "overall": { "judgment": "low|some|high", "rationale": "<1-2 sentences synthesizing the 5 domains>" }
}
</json>
